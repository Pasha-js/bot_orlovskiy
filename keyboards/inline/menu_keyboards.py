...
async def sign_btn():
    initial_keyboard = InlineKeyboardMarkup()
    pay_btn = InlineKeyboardButton(text='Реквізити' + emoji.emojize(":clipboard:"), callback_data=menu_callback.new(item_name='pay'))
...
async def descr_keyboard():
    ...
    additional_btn = InlineKeyboardButton(text='Ознайомчі заняття' + emoji.emojize(":pill:"),
                                          callback_data=menu_callback.new(item_name='lesson'))
    choice_link = InlineKeyboardButton(text='Інстаграм ірини' + emoji.emojize(":up-right_arrow:"), url=INSTA_LINK)
...
async def additional_keyboard():
    ...
    cancel_btn = InlineKeyboardButton(text='Назад' + emoji.emojize(":red_question_mark:"), callback_data=menu_callback.new(item_name='cancel'))
...
async def pay_keyboard():
    ...
    chat_btn = InlineKeyboardButton(text="Написати емейл і телефон", callback_data=menu_callback.new(item_name='chat'))
    initial_keyboard.insert(chat_btn)
    initial_keyboard.insert(cancel_btn)
